    ...
    <div class="div-form">
        <div class="divResult">
            ...
            <div class="btn-index">
                ...
                <button onClick="window.location='index.php';" type="submit" class="voltar-btn-form">Voltar</button>
            </div>
